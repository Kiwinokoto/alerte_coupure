...
- **Reference:** `dev/android-v1` code at `21b4106` (`Resume monitoring after app update`). Workstation clone was clean/synced before this pass. VPS `/opt/powerwatch` remains intentionally at `b9df88e`; `powerwatch-api` is healthy.
